...
<form action="{{route(isset($class) ? 'classes.update' : 'classes.create-post')}}" method="post">
	...
	<div class="form-group">
		...
		<input class="form-control" type="text" id="name" name="name" value="{{isset($class) ? $class->name : ''}}">
	</div>
	<div class="form-group">
		<label for="teacher_name">Teacher Name</label>
		<input class="form-control" type="text" id="teacher_name" name="teacher_name" value="{{isset($class) ? $class->teacher_name : ''}}">
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<input class="form-control" type="number" id="max_student" name="max_student" value="{{isset($class) ? $class->max_student : ''}}">
	</div>
	<div>
